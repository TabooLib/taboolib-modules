...
include("module-database:module-database-core")
include("module-effect:module-effect-core")
include("module-effect:module-effect-wing")
include("module-kether:module-kether-core")
include("module-lang:module-lang-core")
include("module-lang:module-lang-bukkit")
